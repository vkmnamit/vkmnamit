...
import { BarChart3, FileText, Layers, Tag, CreditCard, Receipt, Percent, ShieldBan, AlertTriangle, RefreshCw, Package, BarChart2, TrendingUp, Settings2, ChevronRight, Wallet } from 'lucide-react';
...
const navItems = [
  ...
  { icon: Wallet, label: 'Bills', path: '/fees/bills' },
