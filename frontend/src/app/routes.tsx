...
const FeeBillsPage = lazy(() => import('./pages/fees/finance/FeeBillsPage').then(m => ({ default: m.FeeBillsPage })));
...
const ClassReportsPage = lazy(() => import('./pages/exams/ClassReportsPage').then(m => ({ default: m.ClassReportsPage })));
        ...
        children: [
          ...
          },
          {
            ...
            children: [
              ...
              { path: 'bills', element: S(<FeeBillsPage />) },
